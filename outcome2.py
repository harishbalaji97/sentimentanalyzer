...
def app():
    ...
    with col2:
        try:
            ...
            st.write("0 %")
        try:
            st.write(temp1[temp1['emotions1']=='Unpleasant']['perc%'].values[0])
        except:
            st.write("0 %")
        try:
        ...
        try:
            ...
            st.write("0 %")
        try:
            st.write(temp1[temp1['emotions1']=='Pleasant']['perc%'].values[0])
        except:
            st.write("0 %")
    ...
    with col3:
        ...
        img = img.resize(siz)
        st.image(img)
        img = Image.open("joy_1.png")
        newsize = (27, 27)
        img = img.resize(siz)
        st.image(img)
        img = Image.open("pleasant_1.png")
        newsize = (27, 27)
        img = img.resize(siz)
        st.image(img)
        img = Image.open("sad_1.png")
        newsize = (27, 27)
        img = img.resize(siz)
        st.image(img)
        img = Image.open("anger_1.png")
        newsize = (27, 27)
        img = img.resize(siz)
        st.image(img)
        img = Image.open("fear_1.png")
        newsize = (27, 27)
        img = img.resize(siz)
        st.image(img)
        img = Image.open("disgust_1.png")
        newsize = (27, 27)
        img = img.resize(siz)
        st.image(img)
        img = Image.open("surprised_1.png")
        newsize = (27, 27)
        img = img.resize(siz)
        st.image(img)
